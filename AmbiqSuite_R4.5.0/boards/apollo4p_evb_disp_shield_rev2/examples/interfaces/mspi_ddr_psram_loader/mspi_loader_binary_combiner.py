...
def parse_arguments():
    parser = argparse.ArgumentParser(description =
                     'Combine External PSRAM Loader & external PSRAM image in to a single blob for downloading to internal flash.')

    parser.add_argument('--loaderbin', dest='loaderbin',
                        help='External PSRAM loader binary file (loader.bin)')

    parser.add_argument('--appbin', dest='appbin',
                        help='External PSRAM Application binary file (app.bin)')

    parser.add_argument('--install-address', dest='installaddress', default='0x14000000',
                        help='Install address of the application. Default = 0x14000000 (start of MSPI XIP region)')
    ...
    parser.add_argument('--loader-address', dest='loaderaddress', default='0x00018000',
                        help='Link address of the loader program. Default = 0x00018000 (start of loader program in flash)')
