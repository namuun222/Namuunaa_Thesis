...
Description:
============
 Example demonstrating how to load and run binary image to MSPI external
...
Purpose:
========
This example shows how to load and run a binary image from external
 DDR PSRAM.
 ...
 Prepare the example as follows:
   1. Generate hello_world example to load and execute at MSPI PSRAM XIP location 0x14000000.
      - In the /examples/hello_world/iar directory modify the MRAM region as follows:
